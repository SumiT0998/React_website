    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={"flex-start"} p={"8"} w={"full"} overflowY={"auto"}>
            ...
            <Text>this is a sample video  called description
            this is a sample video  called description
            this is a sample video  called descriptionthis is a sample video  called descriptionthis is a sample video  called description
            this is a sample video   descriptionthis is a sample video  called description
            v</Text>
